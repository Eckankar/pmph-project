...
__global__
void rollback_implicit_x_old_kernel(
        const unsigned outer,
        const unsigned numX,
        const unsigned numY,
        const unsigned numZ,
    ...
    // here yy should have size [numX]
    origTridag(myA,myB,myC,myU,numX,myU,myYY);
}
